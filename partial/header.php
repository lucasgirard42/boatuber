  ...
  <div class="f-header__nav" role="navigation">
    <div class="f-header__nav-grid container max-width-lg">
      ...
      <ul class="f-header__list">
        <li class="f-header__item"><a href="http://boatuber.test/" class="f-header__link">Home</a></li>
        <li class="f-header__item">
        <li class="f-header__item"><a href="produit.php" class="f-header__link">Find a Yacht</a></li>
        <li class="f-header__item"><a href="#0" class="f-header__link" aria-current="page">About us</a></li>
        ...
        <li class="f-header__item"><a href="#0" class="f-header__link">Legal mention</a></li>
      </ul>
  
      <ul class="f-header__list margin-left-auto@md">
        <li class="f-header__item"><a href="#0" class="f-header__btn btn btn--primary">Book a Yacht</a></li>
      </ul>
    </div>
  </div>
</header>